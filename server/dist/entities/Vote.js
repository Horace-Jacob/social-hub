...
let Vote = exports.Vote = class Vote extends typeorm_1.BaseEntity {
};
__decorate([
    (0, typeorm_1.Column)(),
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Users_1.Users, (user) => user.vote),
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Post_1.Post, (post) => post.vote, {
        onDelete: "CASCADE",
    }),
